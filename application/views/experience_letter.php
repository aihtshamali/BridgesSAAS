...
<?php if(file_exists('uploads/Experience_letter/'.$id.'.html')) header('Location: '.base_url().'uploads/Experience_letter/'.$id.'.html'); ?>
...
<div class="container content" style="position: relative; margin-left: 96px; margin-right: 96px;margin-top:25px">
  ...
  <div class="col-md-4 col-xs-5" style="margin-left: 6px"></div><div class="col-md-5 col-xs-5" style="margin-left: -8px" ><?php if($emp->hired_for_project==2){ ?><img src="<?php echo base_url(); ?>Logoz/red-logo.png"  style=" width: 130px;"><?php } else { ?><img src="<?php echo base_url(); ?>Logoz/logo.png"  style=" width: 130px;border: 2px solid gray;"><?php } ?></div>
                  ...
                  <div class="col-md-2 col-xs-2 red " ></div><div class="col-md-8 col-xs-6 lbheader" style="padding-left: 0px;font-style: italic"><p style="padding:0px; margin:0px;font-size:30px;margin-left: 18px;">Experience Letter</p>
                  </div>
                  </div>
          <br><br><br>
...
The Bridges <strong><?php if($emp->hired_for_project==2){ ?> School <?php } else { ?> Consortium<?php } ?>
  ...
  <div class="row" style="clear: both">
    ...
    <p style="border-top:1px solid black">Director</p>
    </div>
    <div style="float:right;margin-right: 20px;margin-top:50px" >
    
    <p style="border-top:1px solid black" align="left">Applicant</p>
    </div>
  </div>
  <br>
...
*/
  ...
  // alert(id);
   ...
   function saveDoc(){
      ...
      jQuery.ajax({
            url: "<?php echo base_url();?>caan/saveExperience/<?=$emp->id;?>",
            type: "POST",
            data: {
