...
<?php if($userdetails->hired_for_project == 2 || $userdetails->hired_for_project==1) {?>
    ...
    <?php  } else{ ?>
      ...
      <div class="th wd-70 u-pd-0 ht-97">
        <div class="th-child" style="padding: 10px 0 0 0; width: 42.5%;"> 
          ...
          <div class="bdr-pd fs-14"><?php if($userdetails->hired_for_project == 2 || $userdetails->hired_for_project==1){ ?>The Bridges School <?php } else{ ?>Bridges Development Consortium<?php } ?></div>
          <div class="db fw-n"></div>
          <div class="db fw-n"></div>
        </div>
      ...
      <p class="yr-txt">Year to Date</p>
          ...
          <div class="db"><?= $userdetails->project_title ?></div>
          <div class="db"><?php echo date('d-m-y',strtotime($userdetails->job_start_date)); ?></div>
          <!-- <div class="db"><?php echo date('t-m-y',strtotime($prev_date)); ?></div> -->
      </div>
...
<!-- Table starts here -->
  <div class="table-custom fs-10 well u-pd-0">
    <div class="thead bg-light-gry h-70 flexbox">
      ...
      <div class="th wd-70 u-pd-0 ht-97">
        <div class="th-child" style="width: 43%;"> 
          <div class="db"><?= $userdetails->firstname?> <?= $userdetails->lastname?></div>
          <div class="db fw-n"><?= $userdetails->designation?></div>
          <div class="db fw-n"><?= $userdetails->Level?></div>
          <div class="db fw-n"><?= $userdetails->cnic_no?></div>
        ...
        <div class="th-child u-tar u-pdr-5 fw-n" style="width: 15%;">
          ...
          <div class="db">Additions:</div>
            <div class="db fs-8"><span class=" dot_gry fnt-wt">Bonus:</span></div>
            <div class="db fs-8"><span class=" dot_gry fnt-wt">Health:</span></div>
            <div class="db fs-8"><span class=" dot_gry fnt-wt">Allowence:</span></div>
        </div>

        <div class="th-child u-pdr-5 wd-12-p fw-n">
      ...
      <div class="tr-row bg-mid-gry  flexbox">
        ...
        <div class="tr wd-70 pd-tp-0">
          ...
          <div class="tr u-tar wd33">
            <div class="db">Current Total:</div>
          </div>
...
<?php } ?>  
  ...
  <div class="table-custom fs-10 well u-pd-0">
    <div class="thead bg-light-gry h-70 flexbox">
      ...
      <div class="th wd-15 wd-12-p fw-n">
          <div class="db">Rs.<?= $userdetails->actual_salary?>/-</div>
          <div class="db">Rs.<?php $after_deduct =((($userdetails->actual_salary)/$maxDays)*$deduction); 
          if($userdetails->hired_for_project==2){
            $after_deduct +=1000;
            echo intVal($after_deduct);
          }
    ...
    <div class="tbody h-70">
      ...
      <div class="tr-row bg-performance ht-35">
          <div class="top-left fs-11 flexbox" >
            <div class="col-md-4 " >
              <label class="fi prpd">Prepared By:</label><span class="lts-0">&emsp;&emsp;------------------------------------------------------</span>
            </div>
            <div class="col-md-4">
              <label class="fi aprvd">Approved By:</label><span class="lts-0">&emsp;&emsp;------------------------------------------------------</span>
            </div>
