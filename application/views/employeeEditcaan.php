...
<body>
    <div class="container cv flexbox">
        ...
        <?php echo form_open('caan/empUpdate/'.$emp->userid); ?>
...
<option value="games">Games</option>
	  ...
	  <option value="6">Asst. Officer<option>
								...
								<li><b>Probation(Days)</b>
								<input type="text" name="probation" class="input-transparent col49" placeholder="Probation Period">
								</li>
                                <span class="text-danger"><?php echo form_error('actual-salary'); ?></span>
                                <li><b>Descripter:</b>
                                    <?php 
