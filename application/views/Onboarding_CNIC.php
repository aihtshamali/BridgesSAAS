...
<body>
	<div class="level_1_heading">
		<div class="container">
					3.1.B  - Employment Profile
		</div>
	</div>
	<div class="container">
				<!-- Level 2 Section -->
				<div class="level_2_row">
					<h3 class="level_2_heading"><i class="fa fa-user" aria-hidden="true" align="center"></i> CNIC</h3>
					<img width="320px" src="<?php echo $upload_cnic; ?>" alt="" style="margin-bottom:10px;">
					<img width="320px" src="<?php echo $upload_cnic_back; ?>" alt="">
				</div>
			</div>
</body>
</html>