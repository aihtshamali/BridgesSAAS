...
<body>
	<div class="level_1_heading">
		<div class="container">
					3.1.A  - Employment Profile
		</div>
	</div>
	<div class="container">
				<!-- Level 2 Section -->
				<div class="level_2_row">
					<h3 class="level_2_heading"><i class="fa fa-user" aria-hidden="true" align=""></i> Profile Picture</h3>
					<div align="">
					<img style="width: 175px;height: 175px;" src="<?php echo $upload_picture; ?>" alt="">
					</div>
				</div>
			</div>
</body>
