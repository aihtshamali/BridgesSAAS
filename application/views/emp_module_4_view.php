	...
	<div class="section_wrapper">
					...
					<div class="row">
						<div class="col-sm-4 col-sm-push-1 profile_inputs full">
							<div class="form-group">
								<label for="date"><a href="http://bridges/bridgessms/Bridges_School_Software/taskmanager-new/Salaryslip/payslip/<?php echo $id;?>">Leaves System</a></label>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="section_wrapper">
			...
			<div class="container">
				...
				<div class="level_2_row">
					<h3 class="level_2_heading"><i class="fa fa-user" aria-hidden="true"></i> Monthly Payroll Sheet 3.4.b.2</h3>
					<div class="row">
						<div class="col-sm-4 col-sm-push-1 profile_inputs full">
							<div class="form-group">
				...
				<div class="level_2_row">
					<h3 class="level_2_heading"><i class="fa fa-user" aria-hidden="true"></i> Compensation Slips 3.4.c.3</h3>
					<div class="row">
						<div class="col-sm-4 col-sm-push-1 profile_inputs full">
							<div class="form-group">
