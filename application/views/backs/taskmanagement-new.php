...
<div class="" style="margin-top:-50px;">
		...
		<div class="row no-row-padding bg-full-gry" style="margin-top:50px;height: 19px;line-height:19px;">
			<div class="col-md-1 text-center border-r e-width" style="text-align:left;"><div class="tabs-dv"><span class="action pull-left"><i class="fa fa-plus" aria-hidden="true"></i><i class="fa fa-pencil-square-o" aria-hidden="true"></i></span>Output - S</div></div>
			<div class="col-md-2 text-center e-width" style="text-align:left;"><div class="tabs-dv">Activities <span class="action"><i class="fa fa-plus" aria-hidden="true" data-toggle="modal" data-target="#addActivity"></i><i class="fa fa-pencil-square-o" aria-hidden="true"></i></span></div></div>
			<div class="col-md-2 text-center border-r " style="text-align:left;margin-left: 480px;"><div class="tabs-dv"><span class="action"><i class="fa fa-plus" aria-hidden="true" onClick="AddTask()"></i><i class="fa fa-pencil-square-o" aria-hidden="true"></i></span>Task &amp; Process </div></div>
			<div class="col-md-1 text-center e-width pull-right" style="text-align:left;"><div class="tabs-dv">Resources <span class="action "><i class="fa fa-plus"  data-toggle="modal" data-target="#addResource" aria-hidden="true"></i><i class="fa fa-pencil-square-o" aria-hidden="true"></i></span></div></div>
		</div>
		<?php
			}
			?>
...
<?php 									for ($i=0; $i < 8; $i++) { 
									...
									?>
									<div class="fs-11 child-box date-diff-result" style="background-color:<?= $this->taskmanagement_m->color($y)?>; color:white">
										<?php
										//echo (($y < 0 ) ? "red" : "green");
