...
<div class="container-fluid">
		...
		<div class="row height-65 parent-for" style="border-bottom:2px solid green;">
					...
					<div class="parent width-20 border-r">
						<div class="row">
								...
								<div class="height-35 cluster-1 btrr-8 bg-light-gry">
									<a href="taskmanagement/task2/<?=$details['task_id']?>?id=<?php echo $_GET['id'];?>" class="small block center"><b><?=$details['taskname']?></b><br><?=$details['taskdescription']?>
									</a>
								</div>
			...
			<div class="col-md-1 e-width" style="background: #ccc;"><?php  var_dump($activity['0']); ?></div>
