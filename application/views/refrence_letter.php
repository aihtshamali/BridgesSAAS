...
<body>
	<div class="level_1_heading">
		<div class="container">
					3.1.C  - Employment Profile
		</div>
	</div>
	<div class="container">
				<!-- Level 2 Section -->
				<div class="level_2_row">
					<h3 class="level_2_heading"><i class="fa fa-user" aria-hidden="true" align="center"></i> Refrence Letter</h3>
					
					<br />
				<p><?php echo $upload_reference_letter; ?></p>
				</div>
			</div>
</body>
</html>