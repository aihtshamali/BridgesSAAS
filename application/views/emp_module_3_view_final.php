					...
					<div class="row">
						<div class="col-sm-4 col-sm-push-1 profile_inputs full">
							<div class="form-group">
								<label for="date"> <a href="<?php echo base_url(); ?>attendance">Attendance System</a></label>
							</div>
						</div>
					</div>
				</div>
			<?php } ?>
				<div class="level_2_row">
					...
					<div class="row">
						<div class="col-sm-4 col-sm-push-1 profile_inputs full">
							<div class="form-group">
								<label for="date"> <a href="<?php echo base_url(); ?>attendance/Attendance_Sheet" target="_blank">Attendance Sheet </a></label>
							</div>
						</div>
					</div>
				</div>
				<div class="level_2_row">
					<h3 class="level_2_heading"><i class="fa fa-user" aria-hidden="true"></i>  Employee Shift and Break Sheet 3.3.a.2 </h3>
					<div class="row">
						<div class="col-sm-4 col-sm-push-1 profile_inputs full">
							<!-- <div class="form-group">
							...
							<div class="form-group">
								<label for="date"> <a target="_blank" href="<?php echo base_url(); ?>attendance/Attendance_Sheet_final">Attendance Sheet </a></label>
							</div>
						</div>
					</div>
				</div>
