...
$( document ).ready(function() {
  ...
  { 
    ...
    //  }
    // });  
    $.post("<?php echo base_url();?>"+"Hr/payslip_getAttendance",{userId:userId,month:"<?php echo $selected_month; ?>"}, function( response )
    {
    ...
    <div class="th wd-15 u-tar wd-12-p img-pd">
      ...
      <div class="th wd-70 u-pd-0 ht-97">
        <div class="th-child" style="padding: 10px 0 0 0; width: 42%;"> 
          <div class="bdr-pd fs-14">Leave Management System</div>
  ...
  <div class="table-custom fs-11  u-pd-0">
    <div class="thead flexbox">
      ...
      <div class="th wd-70  u-pd-0">
        <div class="th-child" style="padding-left: 0px">
      ...
      <div class="th wd-12-p">
          <div class="db" id="data_div"><?php echo  date('d-m-y'); ?>
          ...
          // echo $prev_date;
          echo date('01-'.$selected_month.'-y', strtotime($prev_date)); ?></div>
          <div class="db"><?php echo date('t-'.$selected_month.'-y',strtotime($prev_date)); ?></div>
      </div>
    </div>
  </div>  
        <div class="ShowAttendance "></div>
        <div><p>Remaining Leave - 
          <span ><?php echo $attendance_leave[0]->holidays ?></span>
        </p></div>
<!--  </div> -->
