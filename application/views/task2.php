 ...
 -->
			...
			<div class="output_div">
				<div class="output">
					...
					<div class="output-child output1">
						<p>Output-S</p>
					</div>
					<div class="output-child output2">
						<p>Output-O</p>
				...
				<div class="outcome">
					...
					<input type="hidden" name="hiddenChild" id="hiddenChild" value="1">
					<div class="outcome-child" id="outcome-child-1">
						<!-- <div class="child-level2"><button type="button" class="close" id="close1" onclick="checkID()">&times;</button></div> -->
<?php 	
						
						switch ($clussternumber) 
						{
							case '1':
								$clusters = $cluster1;
								break;
						...
						foreach ($clusters as $activity) 
						{	
							echo "<textarea>".$activity."</textarea>";
								
						}
?>					</div>
					<div class="tool-button-div">
						<button class="btn btn-slim btn-success" id="addOutcome">Add</button>
					</div>
				</div><!-- outcome -->
			</div><!-- output_div -->
			
			<div class="task-div">
				<div class="task-div-header">
					<button class="btn btn-slim btn-success" onClick="AddTask()" >Add Task</button>
					<button class="btn btn-slim btn-success" id="TaskPopup" >Edit Task</button>
				</div>
				<input type="hidden" class="form-control" id="getTaskId"  value="<?= $task->task_id ?>" >
 ...
 -->					  <div class="col-md-12 padding-0">
							...
							<div class="row">
								<div class="height-100 width-80">
									...
									<div class="height-50 cluster-1 btrr-8 bg-light-gry">
									...
									<span class="decorate overflow-ell" onclick="assignedUser(<?php echo $assign->id; ?>)" style="cursor: pointer;"><?= $assign->firstname." ".$assign->lastname?></span>
									<!--  -->
									<span class="absolute blr-0">	
<?php
									$rating = $this->taskmanagement_m->get_assigned_tasks_percentage( $assign->taskid,  $assign->userid);

									echo "<div id='custom-bars'><br><span style='top:8px;background: ".((isset($rating[0])) ? $rating[0] : '#b2aeae' ).";height: 3px;width: 60%;'></span>";
					...
					<div class="row">
						<div class="col-md-12 m-auto">
							<div class="row">
								...
								<div class="col-md-12 padding-0">
									<div class="well mb-0" id="showMsgs">
										<?php
...
<!-- 					<div class="section">
			...
			<div class="tool_div">
					<div class="tool-div-header"></div>
				<input type="hidden" name="hiddenTool" id="hiddenTool" value="1">
				<div class="tool-child" id="tool-child-1">
					<div class="tool-child-head"><span class="badge">1</span><button type="button" class="close" id="toolClose">&times;</button></div>
					<input type="text" name="linkTitle" placeholder="Title">
					<input type="text" name="link" placeholder="Link">
				</div>
				<div class="tool-button-div">
					<button class="btn btn-slim btn-success" id="addTool">Add</button>
					<button class="btn btn-slim btn-info" id="submitTool">Submit</button>
				</div>
			</div><!-- tool_div -->
		</div><!-- container_div -->
...
$(document).ready(function(){
 ...
 //    });
	...
	function assignedUser(userId)
	{
		$(".showEvaluation, .ShowAttendance, .ShowPerformance").html("");
		
		$.post("<?php echo base_url();?>"+"taskmanagement/getAssignedUser",{userId:userId}, function( response ){
